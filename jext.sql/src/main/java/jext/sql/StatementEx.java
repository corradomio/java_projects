...
public class StatementEx implements Statement {
    ...
    @Override
    public ResultSet executeQuery(String sqlx) throws SQLException {
        try {
            this.sqlx = sqlx;
            this.sql = c.resolveNamedQuery(sqlx);
            return new ResultSetEx(this, this.s().executeQuery(sql));
        } catch (SQLException e) {
            throw new jext.sql.SQLException(e, sql, params);
        }
    }

    @Override
    public int executeUpdate(String sqlx) throws SQLException {
        try {
            this.sqlx = sqlx;
            this.sql = c.resolveNamedQuery(sqlx);
    ...
    @Override
    public boolean execute(String sqlx) throws SQLException {
        try {
            this.sqlx = sqlx;
            this.sql = c.resolveNamedQuery(sqlx);
    ...
    @Override
    public int executeUpdate(String sqlx, int autoGeneratedKeys) throws SQLException {
        try {
            this.sqlx = sqlx;
            this.sql = c.resolveNamedQuery(sqlx);
    ...
    @Override
    public int executeUpdate(String sqls, int[] columnIndexes) throws SQLException {
        try {
            this.sqlx = sqlx;
            this.sql = c.resolveNamedQuery(sqlx);
    ...
    @Override
    public int executeUpdate(String sqls, String[] columnNames) throws SQLException {
        try {
            this.sqlx = sqlx;
            this.sql = c.resolveNamedQuery(sqlx);
    ...
    @Override
    public boolean execute(String sqld, int autoGeneratedKeys) throws SQLException {
        try {
            this.sqlx = sqlx;
            this.sql = c.resolveNamedQuery(sqlx);
    ...
    @Override
    public boolean execute(String sqlx, int[] columnIndexes) throws SQLException {
        try {
            this.sqlx = sqlx;
            this.sql = c.resolveNamedQuery(sqlx);
    ...
    @Override
    public boolean execute(String sqlx, String[] columnNames) throws SQLException {
        try {
            this.sqlx = sqlx;
            this.sql = c.resolveNamedQuery(sqlx);
    ...
    @Override
    public long executeLargeUpdate(String sqlx, int autoGeneratedKeys) throws SQLException {
        try {
            this.sqlx = sqlx;
            this.sql = c.resolveNamedQuery(sqlx);
    ...
    @Override
    public long executeLargeUpdate(String sqlx, int[] columnIndexes) throws SQLException {
        try {
            this.sqlx = sqlx;
            this.sql = c.resolveNamedQuery(sqlx);
    ...
    @Override
    public long executeLargeUpdate(String sqlx, String[] columnNames) throws SQLException {
        try {
            this.sqlx = sqlx;
            this.sql = c.resolveNamedQuery(sqlx);
    ...
    @Override
    public long executeLargeUpdate(String sqlx) throws SQLException {
        try {
            this.sqlx = sqlx;
            this.sql = c.resolveNamedQuery(sqlx);
