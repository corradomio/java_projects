...
public class JavaFlightRecorderMetric implements Metric {
    // ----------------------------------------------------------------------
    // Private Fields
    // ----------------------------------------------------------------------
    ...
    private final JavaFlightRecorderProvider provider;
    ...
    JavaFlightRecorderMetric(JavaFlightRecorderProvider provider, String id, String name, String type, String description) {
        this.id = id;
        this.name = name;
    ...
    public boolean equals(Object obj) {
        JavaFlightRecorderMetric that = (JavaFlightRecorderMetric) obj;
