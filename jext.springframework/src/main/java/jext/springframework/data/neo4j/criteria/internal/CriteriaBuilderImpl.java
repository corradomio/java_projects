package jext.springframework.data.neo4j.criteria.internal;

import jext.springframework.data.neo4j.criteria.Neo4jCriteriaBuilder;
...
public class CriteriaBuilderImpl implements Neo4jCriteriaBuilder {
    @Override
