...
public class TestSparseVector extends Assertions {
    ...
    @Test
    void testSum() {
        Vector v1 = Linalg.sparse(new float[]{ 1,0,1,0});
        Vector v2 = Linalg.sparse(new float[]{ 0,1,0,1});
        Vector r = v1.linear(1, 1, v2);
        Vector v3 = Linalg.sparse(new float[]{1,1,1,1});
    ...
    void testLinear() {
        ...
        Vector v3 = Linalg.sparse(new float[]{1,2,1,2});
    ...
    void testZero() {
        ...
        Vector v3 = Linalg.sparse(v1.dim());
