...
public class ContourTrace extends AbstractTrace {
  ...
  public static class ContourBuilder extends TraceBuilder {
     ...
     * Note that multiple color scales can be linked to the same color axis.
     **/
    public ContourBuilder autoContour(boolean autoContour) {
      this.autoContour = autoContour;
      return this;
    }

    public ContourBuilder reverseScale(boolean reverseScale) {
      this.reverseScale = reverseScale;
      return this;
    }

    public ContourBuilder showScale(boolean showScale) {
      this.showScale = showScale;
      return this;
    }

    public ContourBuilder autoColorScale(boolean autoColorScale) {
