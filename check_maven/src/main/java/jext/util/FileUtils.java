...
public class FileUtils {
    ...
    /** List files selected by filter */
    public static List<File> listFiles(File directory, FileFilter fileFilter) {
        List<File> selected = new ArrayList<>();
        listFiles(selected, directory, fileFilter);
        return selected;
    }

    /** List files selected by filter, scan the list of directories */
    public static List<File> listFiles(List<File> dirs, FileFilter fileFilter) {
        List<File> selected = new ArrayList<>();
        dirs.forEach(dir -> listFiles(selected, dir, fileFilter));
        return selected;
    }

    /** Collect the files in 'collectedFiles' */
    public static void listFiles(List<File> collectedFiles, File directory, FileFilter fileFilter)
    {
        ...
        collectedFiles.addAll(asList(selected));
    ...
    public static List<String> toStrings(File file, int nlines) {
        if (file == null || !file.exists())
            return Collections.emptyList();
        List<String> lines = new ArrayList<>();
