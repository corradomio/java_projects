...
public class FastScalaParser {
    ...
    public FastScalaParser(File sourceFile) {
    ...
    public FastScalaParser parse() {
        ...
        for(String line : lines) {
            ...
            // public [abstract] [final] [static] class|enum|interface [@]<name>[typeParams] { ...
                ...
                else if (line.contains(JavaUtils.OBJECT)) {
                    this.role = TypeRole.CLASS;
                }
                else {
    ...
    private static Name parseImport(String line) {
        ...
        String symbol = line.substring(sep+1).trim();
