 ...
 */
package jext.math.exception.util;
...
public class ExceptionContext implements Serializable {
     ...
     */
    private List<jext.math.exception.util.Localizable> msgPatterns;
    /**
     * Various informations that enrich the informative message.
     ...
     * pattern.
     */
    public void addMessage(jext.math.exception.util.Localizable pattern,
                           Object... arguments) {
    ...
    private String buildMessage(Locale locale,
        ...
        for (int i = 0; i < len; i++) {
            final jext.math.exception.util.Localizable pat = msgPatterns.get(i);
    ...
    private void deSerializeMessages(ObjectInputStream in)
        ...
        for (int i = 0; i < len; i++) {
            // Step 3.
            final jext.math.exception.util.Localizable pat = (Localizable) in.readObject();
            msgPatterns.add(pat);
            // Step 4.
