...
import jext.optim.heuristics.bpso.operators.partition.PartitionUpdate;
...
public class CheckPartitionBPSO {
    ...
    public static void main(String[] args) {
        ...
        BinaryParticleSwarmOptimization<Partition> solver = new BinaryParticleSwarmOptimization<>(
            new PartitionUpdate()
        );
        ...
        solver = new BinaryParticleSwarmOptimization<>(
            new PartitionUpdate()
        );
