...
public class SolveTSP {
    ...
    public static void main(String[] args) throws Exception {
        ...
        PlanarGraph pgl = PlanarGraph.of(locations, 10);

        Graph<Location, WeightedUndirectedEdge> gl = pgl.getGraph();

        PlanarGraph pgc = PlanarGraph.of(toVisit, 0);

        Graph<Location, WeightedUndirectedEdge> gc = pgc.getGraph();
